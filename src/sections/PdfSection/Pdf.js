...
import InterFontSource from "../../assets/fonts/Inter/Inter-Regular.ttf";
...
const MyDocument = () => {
  ...
  console.log("Font source:", InterFontSource);
  ...
  const loadFonts = useCallback(async () => {
    ...
    await Promise.all([Font.load({ fontFamily: "Inter" })]);
    ...
    const registerFonts = async () => {
      try {
        await Font.register({
          family: "Inter",
          fonts: [
            { src: InterFontSource, fontWeight: 400, fontStyle: "normal" },
          ],
        });
        setIsFontLoaded(true);
      } catch (error) {
    ...
    return (
      <Document>
        <Page style={styles.body}>
          ...
          {/* <Image style={styles.image} src={image2} alt="image2" /> */}
          <Text style={styles.text}>
  ...
  //       <img style={styles.image} src={image1} alt="image1" />
  ...
  //       <img style={styles.image} src={image2} alt="image2" />
